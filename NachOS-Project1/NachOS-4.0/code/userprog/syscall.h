...
// Doc so nguyen tu input, neu overflow hoac khong phai so nguyen, tra ve 0
int ReadNum();

// In so nguyen ra output
void PrintNum(int number);

// Doc mot ky tu tu input
char ReadChar();

// In ra mot ky tu ra output
void PrintChar(char character);

// Tra ve mot so nguyen ngau nhien
int RandomNum();

// Doc chuoi tu input, luu vao buffer voi do dai length
void ReadString(char buffer[], int length);

// In chuoi buffer ra output
...
#define DefConsoleInput 0
#define DefConsoleOutput 1
